    ...
    <section className="space-y-4">
      <div className="flex items-start gap-3">
        <button
          type="button"
          onClick={onBack}
          className="mt-0.5 inline-flex h-8 w-8 items-center justify-center rounded-lg border border-[#d1d8e0] bg-[#f6f7f9] text-[#1f2b3a]"
        >
          <Icon name="arrow-left" className="h-4 w-4" />
        </button>
        <div>
          <div className="flex flex-wrap items-center gap-2">
            <h1 className="text-3xl font-semibold text-[#0f2431]">{title}</h1>
      ...
      <div className="rounded-xl border border-[#9fb6dd] bg-[#eef3fb] px-4 py-3">
        <p className="text-base font-semibold text-[#153c7a]">Mode Procurement</p>
        <p className="mt-1 text-sm text-[#51697a]">
