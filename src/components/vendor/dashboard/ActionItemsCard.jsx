...
function ActionItemsCard({ actionItems }) {
  return (
    <article className="rounded-2xl border border-[#d9dde4] bg-[#f6f7f9] p-5 shadow-[0_8px_20px_rgba(10,18,35,0.04)]">
      ...
      {actionItems[0] && (
        <div className="group relative mt-4 overflow-hidden rounded-2xl border border-[#d6dbe3] bg-[#f4f6f8] p-4 transition-all duration-300 hover:border-[#f04444]/30 hover:bg-white hover:shadow-md">
